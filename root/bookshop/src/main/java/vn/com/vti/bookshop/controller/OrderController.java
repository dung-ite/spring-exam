...
public class OrderController {
	...
	public String detail(Integer orderHeaderId, Model model, @AuthenticationPrincipal MemberDetails memberDetails ) {
		//TODO ログインしている会員の注文IDであるかチェック

		OrderHeader orderHeader = orderHeaderMapper.selectByPrimaryKey(orderHeaderId);
		if(!orderHeader.getMemberId().equals(memberDetails.getMember().getId())) {
			return "redirect:/";
		}
