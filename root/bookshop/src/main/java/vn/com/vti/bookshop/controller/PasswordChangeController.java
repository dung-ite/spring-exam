...
public class PasswordChangeController {
	...
	@PostMapping("update")
	public String update(@Valid PasswordChangeForm passwordChangeForm, BindingResult bindingResult, 
			RedirectAttributes redirectAttributes, @AuthenticationPrincipal MemberDetails memberDetails) {
